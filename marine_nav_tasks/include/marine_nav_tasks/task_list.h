#ifndef MARINE_NAV_TASKS_TASKLIST_H
#define MARINE_NAV_TASKS_TASKLIST_H
...
public:
  ...
  void update(const std::vector<TaskInformation>& task_msgs, rclcpp::Clock::SharedPtr clock = {});
  ...
  /// down the children. 
  std::vector<TaskInformation> taskMessages() const;
